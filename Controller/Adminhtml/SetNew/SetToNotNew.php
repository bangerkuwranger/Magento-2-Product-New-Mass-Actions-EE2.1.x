...
class SetToNotNewAction extends \Magento\Backend\App\Action {
	...
	public function execute() {
		...
		if( !empty( $products ) ) {
			...
			$this->_messageManager->addSuccessMessage( __( '%1 product(s) have been set to not new', count( $products ) ) );
